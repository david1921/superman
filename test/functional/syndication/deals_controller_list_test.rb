...
# hydra class Syndication::DealsControllerListTest

class Syndication::DealsControllerListTest < ActionController::TestCase
  ...
  context "sort" do
    ...
    should "render with supplied sort parameter" do
      get :list, :sort => Syndication::SearchRequest::Sort::PRICE_DESCENDING
      assert_response :success
      assert_select "select[name='sort']"
  ...
  context "filter defaults" do
    setup do
      @publisher2 = Factory(:publisher_with_address, :self_serve => true, :zip => "97211")
      @user2 = Factory(:user, :company => @publisher2, :allow_syndication_access => true)
      login_as @user2
    end

    should "have default radius of 50" do
      get :list
      assert_response :success
      assert_equal 50, assigns(:search_request).filter.radius
    end
  end
  ...
  context "filter" do
    ...
    should "have default page size to 4" do
      get :list, :search_request => @search_request_parameters
      assert_response :success
      assert_equal 4, assigns(:search_request).paging.page_size
    end
    ...
    should "render with default parameters" do
      ...
      assert_select "#filter_search" do
        assert_select "form[action='#{list_syndication_deals_path}'][method='get']" do
    ...
    context "reset" do
      setup do
        get :list, :search_request => @search_request_parameters, :reset => 'Reset'
        assert_response :success
      end
  ...
  context "sort and filter" do
    setup do
      login_as @user
      get :list, {:sort => Syndication::SearchRequest::Sort::PRICE_DESCENDING, :search_request => @search_request_parameters}
    end
